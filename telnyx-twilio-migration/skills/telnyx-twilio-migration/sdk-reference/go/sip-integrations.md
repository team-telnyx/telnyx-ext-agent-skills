...
```go
	recordingTranscriptions, err := client.RecordingTranscriptions.List(context.Background())
	if err != nil {
		log.Fatal(err)
	}
...
```go
	err := client.Recordings.Actions.Delete(context.Background(), telnyx.RecordingActionDeleteParams{
