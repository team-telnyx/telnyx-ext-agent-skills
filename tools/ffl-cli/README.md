...
export TELNYX_FRICTION_ENDPOINT="http://ffl-backend.query.dev.telnyx.io:3000/v2/friction"

# Production endpoint is configured by default (no override needed)
```

**Note:** Production endpoint is hardcoded in the CLI (requires VPN access to Telnyx internal network).
...
os.environ["TELNYX_FRICTION_ENDPOINT"] = "http://ffl-backend.query.dev.telnyx.io:3000/v2/friction"
